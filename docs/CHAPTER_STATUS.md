...
| 3 基于Vision-xLSTM局部--全局协同建模的三维医学图像分割方法 | `chapters/ch03_vil_unet.tex` | FROZEN_V1.0 | PLANNED | `A3-B3_RECOVERY_KNOWLEDGE_PASSED / OPERATIONAL_QUALIFICATION_PENDING`; Work1 complete loop: problem, method, experiment, analysis, conclusion. |
