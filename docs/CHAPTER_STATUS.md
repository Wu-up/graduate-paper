...
| 3 基于Vision-xLSTM局部--全局协同建模的三维医学图像分割方法 | `chapters/ch03_vil_unet.tex` | FROZEN_V1.0 | PLANNED | `SUCCESSOR_QUALITY_GATE_PASSED / A3-B3_READY`; Work1 complete loop: problem, method, experiment, analysis, conclusion. |
